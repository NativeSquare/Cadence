/**
 * Account / health screen — stubbed during agoge migration.
 *
 * This screen edited Cadence's deleted runners.health fields. Per the refactor,
  ...
  return (
    <View style={{ flex: 1, justifyContent: "center", alignItems: "center", padding: 24, backgroundColor: LIGHT_THEME.bg }}>
      <Text style={{ color: LIGHT_THEME.wText, textAlign: "center", fontSize: 16 }}>
        Health preferences now live with your Coach.
      </Text>
