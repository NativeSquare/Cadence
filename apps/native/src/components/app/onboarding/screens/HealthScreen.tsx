...
export function HealthScreen({ onNext }: HealthScreenProps) {
  ...
  const intro = useStream({
    text: "Nice. Your data looks clean — no big injury gaps. But I want to hear it from you. Any past injuries?",
    speed: 14,
    delay: 300,
  });
