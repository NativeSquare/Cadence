export default function PrivacyPage() {
  return (
    <div className="container mx-auto max-w-3xl px-6 py-16">
      ...
      <p className="text-[#8E8E93] mb-8">Last updated: February 14, 2026</p>
      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <ul className="list-disc list-inside text-[#8E8E93] space-y-3">
            <li>
            ...
            <li>
              ...
              Cadence, the software program provided by the Company.
            </li>
            <li>
              <strong className="text-white">Company</strong> (referred to as
              either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
              &quot;Our&quot; in this Privacy Policy) refers to NativeSquare, 60
              rue Fran&ccedil;ois Ier.
            </li>
            <li>
              <strong className="text-white">Country</strong> refers to: France
            </li>
            <li>
            ...
            <li>
              <strong className="text-white">Service Provider</strong> means any
            ...
            <li>
              <strong className="text-white">Usage Data</strong> refers to data
        ...
        <section>
          ...
          <ul className="list-disc list-inside text-[#8E8E93] space-y-2 mb-6">
            <li>Email address</li>
          ...
          <ul className="list-disc list-inside text-[#8E8E93] space-y-2 mb-4">
        ...
        <section>
          ...
          <ul className="list-disc list-inside text-[#8E8E93] space-y-3 mb-6">
            <li>
              <strong className="text-white">
            ...
            <li>
              <strong className="text-white">To manage Your Account:</strong> to
            ...
            <li>
              <strong className="text-white">To contact You:</strong> To contact
            ...
            <li>
              <strong className="text-white">To provide You</strong> with news,
              ...
              already purchased or inquired about unless You have opted not to
            ...
            <li>
              ...
              may use Your Personal Data to evaluate or conduct a merger,
            ...
            <li>
              <strong className="text-white">For other purposes:</strong> We may
          ...
          <ul className="list-disc list-inside text-[#8E8E93] space-y-3">
            ...
            <li>
              <strong className="text-white">With other users:</strong> If Our
        ...
        <section>
          ...
          <ul className="list-disc list-inside text-[#8E8E93] space-y-2 mb-4">
            <li>
              <strong className="text-white">User Accounts:</strong> retained
              for the duration of your account relationship plus up to 24 months
              after account closure to handle any post-termination issues or
              resolve disputes.
            </li>
          </ul>
          ...
          <ul className="list-disc list-inside text-[#8E8E93] space-y-2 mb-4">
            <li>
              ...
              up to 24 months from the date of ticket closure to resolve
              follow-up inquiries, track service quality, and defend against
              potential legal claims.
            </li>
            <li>
              <strong className="text-white">Chat transcripts:</strong> up to 24
              months for quality assurance and staff training purposes.
            </li>
          </ul>
          ...
          <ul className="list-disc list-inside text-[#8E8E93] space-y-2 mb-4">
            <li>
              <strong className="text-white">Legal obligation:</strong> We are
              required by law to retain specific data (e.g., financial records
              for tax authorities).
            </li>
            <li>
              <strong className="text-white">Legal claims:</strong> Data is
              necessary to establish, exercise, or defend legal claims.
            </li>
            <li>
              <strong className="text-white">Your explicit request:</strong> You
              ask Us to retain specific information.
            </li>
            <li>
              <strong className="text-white">Technical limitations:</strong>{" "}
          ...
          <ul className="list-disc list-inside text-[#8E8E93] space-y-2">
            <li>
              <strong className="text-white">Deletion:</strong> Personal Data is
              removed from Our systems and no longer actively processed.
            </li>
            <li>
              <strong className="text-white">Backup retention:</strong> Residual
              copies may remain in encrypted backups for a limited period
              consistent with our backup retention schedule and are not restored
              except where necessary for security, disaster recovery, or legal
              compliance.
            </li>
            <li>
              <strong className="text-white">Anonymization:</strong> In some
              cases, We convert Personal Data into anonymous statistical data
              that cannot be linked back to You. This anonymized data may be
              retained indefinitely for research and analytics.
            </li>
          </ul>
        </section>
