...
- [ ] **Task 1: Create DebriefScreen.tsx container** (AC: 1, 2)
  - [ ] 1.1: Set up phase state management (`ph`, `feeling`, `noteText`, `selectedPills`, `submitted`, `coachReply`, `recording`, `recTime`, `celebrating`)
  - [ ] 1.2: Implement scrollRef for auto-scroll behavior
  - [ ] 1.3: Create dark hero header with completion badge
  - [ ] 1.4: Implement stats row with springUp animation using Reanimated
  - [ ] 1.5: Add light content area with rounded top corners (borderRadius 28px)

- [ ] **Task 2: Create FeelingSelector.tsx component** (AC: 3)
  - [ ] 2.1: Define FEELING_OPTIONS constant with exact values from prototype
  - [ ] 2.2: Implement vertical stacked buttons with emoji, label, description
  - [ ] 2.3: Add selection state styling (lime border, glow background, checkmark)
  - [ ] 2.4: Implement staggered springUp animation using Reanimated entering

- [ ] **Task 3: Create QuickTagPills.tsx component** (AC: 4)
  - [ ] 3.1: Define DEBRIEF_PILLS constant with exact values
  - [ ] 3.2: Implement flex-wrap pill layout
  - [ ] 3.3: Add toggle logic for multi-select
  - [ ] 3.4: Style dashed vs solid border states

- [ ] **Task 4: Create VoiceRecorderMode.tsx component** (AC: 5)
  - [ ] 4.1: Implement recording state with timer
  - [ ] 4.2: Create animated waveform bars (24 bars)
  - [ ] 4.3: Add Cancel and Done buttons
  - [ ] 4.4: Implement mock transcription on Done (for MVP)

- [ ] **Task 5: Create DebriefNoteInput.tsx component** (AC: 6)
  - [ ] 5.1: Implement textarea with placeholder styling
  - [ ] 5.2: Add mic button (bottom left)
  - [ ] 5.3: Add character count (bottom right)
  - [ ] 5.4: Implement send arrow button with scaleIn animation

- [ ] **Task 6: Create CoachResponseCard.tsx component** (AC: 7)
  - [ ] 6.1: Create card with gradient background effect
  - [ ] 6.2: Add coach avatar (lime circle with "C")
  - [ ] 6.3: Implement useStreamingText hook for character streaming
  - [ ] 6.4: Add blinking cursor during streaming

- [ ] **Task 7: Create DebriefSummary.tsx component** (AC: 8)
  - [ ] 7.1: Create "Logged" card with checkmark
  - [ ] 7.2: Display feeling emoji + label pill
  - [ ] 7.3: Display selected pills
  - [ ] 7.4: Show "Note added" indicator if noteText present

- [ ] **Task 8: Create DebriefHeader.tsx component** (AC: 1, 2)
  - [ ] 8.1: Extract header + stats row into reusable component
  - [ ] 8.2: Accept session data and elapsed time as props

- [ ] **Task 9: Add navigation and integration** (AC: 9)
  - [ ] 9.1: Create navigation route for Debrief screen
  - [ ] 9.2: Accept session, elapsedTime, distanceCovered as route params
  - [ ] 9.3: Implement onDone callback to trigger celebration
  - [ ] 9.4: Create barrel export in `components/app/debrief/index.ts`
