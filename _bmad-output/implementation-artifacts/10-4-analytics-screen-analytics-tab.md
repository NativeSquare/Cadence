...
### Phase 1: Foundation
- [ ] **Task 1.1** Create `AnalyticsScreen.tsx` component (AC: 1)
  - [ ] Set up ScrollView container matching existing screen patterns
  - [ ] Header with "Analytics" title, plan summary
  - [ ] Bottom padding for tab bar clearance (paddingBottom: 120)

### Phase 2: Plan Progress Component
- [ ] **Task 2.1** Create `PlanProgress.tsx` component (AC: 1, 8)
  - [ ] 10-week progress bar with phase colors (Build/Peak/Taper/Race)
  - [ ] Current week indicator with dot marker
  - [ ] Legend row with phase colors
  - [ ] Phase colors: Build=#A8D900, Peak=#C8FF00, Taper=#5B9EFF, Race=#FF5A5A

### Phase 3: Volume & Streak Cards
- [ ] **Task 3.1** Create `WeekVolumeCard.tsx` component (AC: 2)
...
- [ ] **Task 4.2** Create `StackedHistogram.tsx` component (AC: 4, 8)
...
- [ ] **Task 5.1** Create `LineChart.tsx` reusable component (AC: 5, 6, 8)
...
- [ ] **Task 5.2** Apply to VolumeChart variant (AC: 5)
  - [ ] Lime color line (#C8FF00)
  - [ ] Gradient fill from lime 25% opacity to 2%
  - [ ] "+8%" badge styling

- [ ] **Task 5.3** Apply to PaceChart variant (AC: 6)
  - [ ] Blue color line (#5B9EFF)
  - [ ] "-33s" improvement badge

### Phase 6: Stats Grid
- [ ] **Task 6.1** Create `StatsGrid.tsx` component (AC: 7, 8)
  - [ ] 2x2 grid layout
...
- [ ] **Task 7.1** Create analytics data hook `useAnalyticsData.ts`
...
- [ ] **Task 8.1** Integrate all components in AnalyticsScreen
  - [ ] Proper spacing between sections (12-16px)
  - [ ] Animation orchestration (stagger component reveals)
  - [ ] Error state handling
  - [ ] Loading skeleton (optional, can use reused pattern)
...
```typescript
import Svg, { Path, Line, Circle, Rect, G, Defs, LinearGradient, Stop } from "react-native-svg";
